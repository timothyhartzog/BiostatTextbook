...
**Phase:** Chapter | **Tier:** expert | **Chapter:** 30
**File:** `chapters/expert/30-putting-it-together.qmd`
**Prerequisites (chapters):** ALL

## Textbook Content

- PICOT/FINER
- Study design selection (master decision tree)
...
2. **Methods Section Writer**
3. **Results Section Writer**
4. **Reviewer Response Helper**
5. **Full Analysis Walkthrough**

## WebR User Data Analysis

Complete Pipeline (upload → EDA → test selection → analysis → report); Publication Package Generator

## Quality Gates

- Chapter renders: `quarto render chapters/expert/30-putting-it-together.qmd` succeeds
...
**IMPORTANT:** Only modify `chapters/expert/30-putting-it-together.qmd`. Do NOT modify `_quarto.yml`, shared JS modules, or other chapter files.
